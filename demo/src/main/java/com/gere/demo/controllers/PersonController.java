...
import com.gere.demo.services.PersonService;
...
public class PersonController {
    ...
    public Page<PersonListDTO> list(
    ...
    public PersonRes create(@RequestBody @Valid PersonCreateReq req) {
    ...
    @PatchMapping("/{id}")
    public PersonRes update(@PathVariable Integer id,
            @RequestBody @Valid PersonUpdateReq req) {
